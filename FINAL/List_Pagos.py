...
while True:
    ...
    try:
        ...
        while True:
            ...
            datos = eval(aux)
            print(datos)
            sql1 = "SELECT Servicio.Nombre, Pago.Monto, Pago.Fecha FROM (Pago INNER JOIN Servicio ON Pago.Servicio_idServicio = Servicio.idServicio) WHERE Pago.Cuenta_idCuenta = ?;"
